...
SQLITE_WRITES_ENV = "XRAY_MANAGER_SQLITE_WRITES"
SQLITE_WRITES_SERVER_ENV = "MANAGER_SQLITE_WRITES_ENABLED"
...
def sqlite_writes_enabled() -> bool:
    if SQLITE_WRITES_ENV in os.environ:
        return truthy(os.environ.get(SQLITE_WRITES_ENV))
    return truthy(read_server_env().get(SQLITE_WRITES_SERVER_ENV))
