...
В списке показываются статус, online/offline, последнее подключение, срок доступа, дата добавления, лимит и трафик по клиенту:

```text
Connection: default  |  PORT=443  |  SNI=www.microsoft.com  |  TAG=vless-reality
+------------+---------+---------+----------+----------+----------+------------+----------------------+------------------+----------------------+
| NAME       | STATUS  | ONLINE  | IN       | OUT      | TOTAL    | LIMIT      | LAST ONLINE          | ACCESS UNTIL     | CREATED              |
+------------+---------+---------+----------+----------+----------+------------+----------------------+------------------+----------------------+
| starter    | enabled | offline | 0.00KB   | 0.00KB   | 0.00KB   | без лимита | never                | бессрочно        | 2026-06-03T22:37:11Z |
+------------+---------+---------+----------+----------+----------+------------+----------------------+------------------+----------------------+
...
| NAME      | STATUS  | ONLINE | IN       | OUT      | TOTAL    | LIMIT      | LAST ONLINE          | ACCESS UNTIL     | CREATED              |
+-----------+---------+--------+----------+----------+----------+------------+----------------------+------------------+----------------------+
| phone | enabled | online | 245.20MB | 292.36MB | 537.56MB | 15.00GB/day | 2026-06-04 09:33 UTC | 2026-07-04 00:00 | 2026-06-03T22:38:51Z |
+-----------+---------+--------+----------+----------+----------+------------+----------------------+------------------+----------------------+
```
