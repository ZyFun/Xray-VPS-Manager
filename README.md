...
| Manager Updated | 2026-06-11 22:55 UTC                                         |
...
Кнопка `Получить VLESS-ссылку` и fallback-команда `/link` отправляют пользователю актуальную ссылку из текущей конфигурации сервера. Это удобно после изменения порта, SNI, fingerprint или других Reality-параметров.
