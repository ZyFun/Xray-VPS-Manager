...
| Manager Updated | 2026-06-05 13:09 UTC |
...
Архив содержит Reality private key, UUID клиентов и статистику трафика, поэтому его нужно хранить как приватный секрет.
