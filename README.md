...
Если база уже существует, перед импортом создаётся pre-import backup SQLite-базы. Старые JSON-файлы не удаляются и остаются rollback-источником до финального cutover.
